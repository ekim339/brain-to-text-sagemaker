...
def main():
    parser = argparse.ArgumentParser(description='Train Brain-to-Text model on SageMaker with S3 data streaming')
    ...
    # Configuration
    parser.add_argument('--config-file', type=str, default='rnn_args.yaml',
    ...
    print("="*80)
    print("NEJM Brain-to-Text Training on AWS SageMaker")
    print("="*80)
    ...
    # Initialize trainer with S3 support
    print("\n" + "="*80)
    print("Initializing S3-Enabled Trainer")
    print("="*80)
    
    trainer = BrainToTextDecoder_Trainer_S3(training_args)
    ...
    print("="*80)
    print(f"Best validation DER: {trainer.best_val_PER:.4f}")
