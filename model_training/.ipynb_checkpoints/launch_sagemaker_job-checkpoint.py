...
def launch_training_job(
    job_name=None,
    s3_bucket='4k-eugene-btt',
    s3_data_prefix='hdf5_data_diphone_encoded',
    instance_type='ml.g4dn.2xlarge',  # GPU instance
    instance_count=1,
    config_file='rnn_args_diphone_sagemaker.yaml',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config-file', type=str, 
                        default='rnn_args_diphone_sagemaker.yaml',
